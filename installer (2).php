...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'shop_29e2a5789f1606fa7018_20221109090339_archive.zip';
	const ARCHIVE_SIZE		 = '73360581';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '29e2a57-09090339';
    const SECONDARY_PACKAGE_HASH = '47f9f08-09090339';
	const VERSION			 = '1.4.6';
